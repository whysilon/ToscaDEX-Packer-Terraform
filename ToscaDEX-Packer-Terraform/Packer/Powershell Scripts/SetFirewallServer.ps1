...
New-NetFirewallRule -DisplayName "TricentisDistributedExecutionMonitor" -Description "TricentisDistributedExecutionMonitor" -Direction Outbound -LocalPort 5008 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "ToscaDistributionServer" -Description "ToscaDistributionServer" -Direction Inbound -LocalPort 5007 -Protocol TCP -Action Allow
